...
This reference owns Reference Lesson calibration, module-by-module authoring and the pedagogical rules not owned by the plain-Russian or platform contracts.

## Contents

- [Calibrate a Reference Lesson](#4-calibrate-a-reference-lesson)
- [Author the Course Module by Module](#5-author-the-course-module-by-module)
- [Scaffold and then remove support](#scaffold-and-then-remove-support)
- [Make the learner act](#make-the-learner-act)
- [Design errors diagnostically](#design-errors-diagnostically)
- [Plan Cumulative Retrieval](#plan-cumulative-retrieval)
- [Use a respectful Course Voice](#use-a-respectful-course-voice)

Plain-language explanation, idiomatic Russian, translation and comprehension rules live in [`plain-russian-contract.md`](plain-russian-contract.md) and are mandatory during authoring.
...
The operational language rules live in
[`plain-russian-contract.md`](plain-russian-contract.md); their research and editorial
rationale lives in [`plain-language-evidence.md`](plain-language-evidence.md).
